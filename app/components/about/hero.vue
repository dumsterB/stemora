  ...
  <section id="hero" class="flex h-dvh items-center justify-center">
    <div class="container grid grid-cols-1 gap-6 lg:grid-cols-2">
      <div class="order-2 text-center lg:order-1 lg:text-start">
        ...
        <p class="text-[14px] leading-[120%] font-medium tracking-[0%] lg:text-[18px]">
          We provide trusted services built on modern steam technology, eco-friendly solutions, and a customer-first
          approach. Our goal is to help New Yorkers maintain clean, fresh, and healthy spaces — whether at home or in
          the office.
        </p>
      </div>

      <img alt="sofa" src="~/assets/images/work.png" class="order-1 h-auto w-full object-contain lg:order-2" />
    </div>
  </section>
</template>
