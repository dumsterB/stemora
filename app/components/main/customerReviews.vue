...
<template>
  <section id="customer-review" class="mt-[55px]">
    <h2 class="text-blue mb-[54px] text-center text-[24px] leading-[110%] font-semibold lg:text-[42px]">
      Customer Reviews
    </h2>
