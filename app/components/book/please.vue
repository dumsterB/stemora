<template>
  <section class="container my-[120px] space-y-6 text-center">
    ...
    <p class="text-[14px] font-medium lg:text-[20px]">
      ...
      for 11am please expect us to arrive between 11am - 1pm as this time frame was created in case of traffic, trouble
      finding parking and/or other delays that may occur during the day.
    </p>
  </section>
</template>
